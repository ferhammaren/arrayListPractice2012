...
public class Practica1Algoritmos {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Linea> coordenadas = new ArrayList<Linea>();
...
//                    for (int i = 0; i < numero1; i++) {
                    for (int j = 0; j < numero1; j++) {
                        ...
                        coordenadas.get(j).coordenadasAleatorias(mundo.getWidth(), mundo.getHeight());
                    }
                    Turtle tortuga = new Turtle(coordenadas.get(0).getInitialX(), coordenadas.get(0).getInitialY(), mundo);
